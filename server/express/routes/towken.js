...
router.post('/create', function (req, res, next) {
    ...
    var tokenDetails = req.body.token_details;
    var tokenType = req.body.type_of_token;
    var tokenQuantity = req.body.token_quantity;

    if (userId && type.toLowerCase() == 'business') {
        if (businessName && timeRemaining && mile && discount && latitude && longitude && tokenDetails && tokenType && startTime) {
            TowkenModel.find({
